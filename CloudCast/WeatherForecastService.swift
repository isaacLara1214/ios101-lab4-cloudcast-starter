...
//  CloudCast
//
//  Created by Isaac Lara on 3/20/25.
//
...
class WeatherForecastService {
    static func fetchForecast(latitude: Double,
        ...
        let task = URLSession.shared.dataTask(with: url) { data, response, error in   // this closure is fired when the response is received
